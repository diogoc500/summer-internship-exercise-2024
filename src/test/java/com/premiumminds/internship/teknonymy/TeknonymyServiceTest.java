...
public class TeknonymyServiceTest {
    ...
    private Person getPerson3() {
         ...
         * Verified by me:
         * - The code generated by ChatGPT does indeed correspond to a tree (connected acyclic graph, all edges
         * point 'downwards').
    ...
    private Person createPerson(String name, Character sex, int yearOfBirth, Person[] children) {
